...
<nav>
 ...
 <div class="nav-links">
  ...
  <button class="nav-btn" onclick="toggleDark()">
   🌙
  </button>
 </div>
...
<section class="hero" id="home">
 ...
 <div class="hero-content">
  ...
  <p>
   Turning technology, creativity and learning into
...
<section class="color-section" id="mission">
 ...
 <div class="mission">
  ...
  <div class="mission-card">
   ...
   <h3>Education</h3>
   <p>
    Encourage people to learn digital and
    technology skills.
   </p>
  </div>
  ...
  <div class="mission-card">
   ...
   <h3>Community</h3>
   <p>
    Explore ways technology can create positive
    community impact.
   </p>
  </div>
...
<section class="section" id="projects">
 ...
 <p class="subtitle">
  Technology, education and community projects designed
  around learning and positive impact.
 </p>
...
<section class="section" id="services">
 ...
 <p class="subtitle">
  We provide learning opportunities that help people
  discover technology and build useful skills.
 </p>
 ...
 <div class="services">
  ...
  <div class="service-card">
   ...
   <p>
    ...
    for beginners and learners who want to start
    programming.
   </p>
 ...
 <div class="gallery-grid">
  ...
  <div class="gallery-card">
   ...
   <div class="gallery-caption">
    ...
    <p>
     Learning, collaboration and technology in
  ...
  <div class="gallery-card">
   ...
   <div class="gallery-caption">
    ...
    <p>
     A community learning activity focused on
...
<!-- VIEWER COUNTER IS AT THE VERY BOTTOM -->
